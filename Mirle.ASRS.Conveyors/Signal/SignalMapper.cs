    ...
    public class SignalMapper
    {
        ...
        private List<ConveyorDefine> GetDefaultMaps()
        {
            ...
            conveyor.Buffers = new List<BufferDefine>()
            {
                ...
                new BufferDefine() { BufferIndex = 10, BufferName = "A1-10" },
                new BufferDefine() { BufferIndex = 11, BufferName = "A1-11" },
                new BufferDefine() { BufferIndex = 12, BufferName = "A1-12" },
                ...
                new BufferDefine() { BufferIndex = 22, BufferName = "A2-10" },
                new BufferDefine() { BufferIndex = 23, BufferName = "A2-11" },
                new BufferDefine() { BufferIndex = 24, BufferName = "A2-12" },
                ...
                new BufferDefine() { BufferIndex = 30, BufferName = "A11-1" },
                new BufferDefine() { BufferIndex = 31, BufferName = "A11-2" },
                ...
                new BufferDefine() { BufferIndex = 40, BufferName = "A11-3" },
                new BufferDefine() { BufferIndex = 41, BufferName = "A11-4" },
                ...
                new BufferDefine() { BufferIndex = 46, BufferName = "A7-01" },
                new BufferDefine() { BufferIndex = 47, BufferName = "A11-5" },
                new BufferDefine() { BufferIndex = 48, BufferName = "A11-6" },
            };
            ...
            conveyor.Buffers = new List<BufferDefine>()
            {
                ...
                new BufferDefine() { BufferIndex = 10, BufferName = "B1-10" },
                new BufferDefine() { BufferIndex = 11, BufferName = "B1-11" },
                new BufferDefine() { BufferIndex = 12, BufferName = "B1-12" },
                new BufferDefine() { BufferIndex = 13, BufferName = "B02-1" },
                new BufferDefine() { BufferIndex = 14, BufferName = "B02-2" },
                new BufferDefine() { BufferIndex = 15, BufferName = "B02-3" },
                new BufferDefine() { BufferIndex = 16, BufferName = "B02-4" },
                new BufferDefine() { BufferIndex = 17, BufferName = "B02-5" },
                new BufferDefine() { BufferIndex = 18, BufferName = "B02-6" },
                new BufferDefine() { BufferIndex = 19, BufferName = "B02-7" },
                new BufferDefine() { BufferIndex = 20, BufferName = "B02-8" },
                new BufferDefine() { BufferIndex = 21, BufferName = "B02-9" },
                new BufferDefine() { BufferIndex = 22, BufferName = "B2-10" },
                new BufferDefine() { BufferIndex = 23, BufferName = "B2-11" },
                new BufferDefine() { BufferIndex = 24, BufferName = "B2-12" },
