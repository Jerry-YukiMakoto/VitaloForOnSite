...
namespace Mirle.ASRS.Conveyors.MPLCView
{
    public partial class MainView : Form
    {
        ...
        public MainView(IMPLCProvider mplc, MPLCViewController mplcViewController)
        {
            InitializeComponent();
            _mplc = mplc;
            _mplcViewController = mplcViewController;
            _conveyor = new Conveyor(mplc, 1);
            _conveyor2 = new Conveyor(mplc, 2);
        }
