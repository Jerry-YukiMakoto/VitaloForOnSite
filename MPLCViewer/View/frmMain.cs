...
namespace Mirle.MPLCViewer.View
{
    public partial class frmMain : Form
    {
        ...
        private frmFindMultipleView _frmFindMultipleView;
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            {
                _mplcViewController = LoadMPLCViewControllerByFile(AppDomain.CurrentDomain.BaseDirectory + _config.LogViewer.DefaultDLL);
            }
                ...
                if (assembly != null)
                {
                    ...
                    foreach (var type in types)
                    {
                        if (!type.IsInterface && !type.IsAbstract)
                        {
                            ...
                            {
                                return (IMPLCViewController)Activator.CreateInstance(type, _config.LogViewer.SignalGroup);
                            }
                        }
                    }
                }
        ...
        private void buttonFindMulti_Click(object sender, EventArgs e)
        {
            if (_frmFindMultipleView == null || _frmFindMultipleView.IsDisposed)
            {
                _frmFindMultipleView = new frmFindMultipleView(_config, this, _fReader, _mplcViewController, _filePaths);
            }

            _frmFindMultipleView.Show();
            _frmFindMultipleView.WindowState = FormWindowState.Normal;
            _frmFindMultipleView.Focus();
            _frmFindMultipleView.TopMost = true;
        }
    }
}
